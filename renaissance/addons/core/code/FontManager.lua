...
function FontManager:New()
	local obj =
	{
		fonts = {} -- this gets turned into a weak table, which means entries aren't counted for reference counting, i.e. they will be deleted when there are no more other references
	}
