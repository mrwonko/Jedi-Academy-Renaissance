...
template void G_SetWalkerVehicleFunctions< moduleType::game >( vehicleInfo_t *pVehInfo );
template void G_SetWalkerVehicleFunctions< moduleType::cgame >( vehicleInfo_t *pVehInfo );
...
void G_CreateWalkerNPC( Vehicle_t **pVeh, const char *strAnimalType )
{
	...
	(*pVeh)->m_pVehicleInfo = &g_vehicleInfo[BG_VehicleGetIndex< mod >( strAnimalType )];
}
template void G_CreateWalkerNPC< moduleType::game >( Vehicle_t **pVeh, const char *strAnimalType );
template void G_CreateWalkerNPC< moduleType::cgame >( Vehicle_t **pVeh, const char *strAnimalType );
