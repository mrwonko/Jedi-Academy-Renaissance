...
void NPC_BSGrenadier_Attack( void )
{
	...
	{//enemy is close and not using saber
		...
		{//grenadier
			trace_t	trace;
			g_trap->Trace ( &trace, NPCS.NPC->r.currentOrigin, NPCS.NPC->enemy->r.mins, NPCS.NPC->enemy->r.maxs, NPCS.NPC->enemy->r.currentOrigin, NPCS.NPC->s.number, NPCS.NPC->enemy->clipmask, qfalse, 0, 0 );
