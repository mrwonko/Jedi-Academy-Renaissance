...
void Wampa_SetBolts( gentity_t *self )
{
	if ( self && self->client )
	{
		...
		//ri->cervicalBolt = g_trap->G2API_AddBolt(self->ghoul2, 0, "neck_bone" );
		//ri->chestBolt = g_trap->G2API_AddBolt(self->ghoul2, 0, "upper_spine");
		//ri->gutBolt = g_trap->G2API_AddBolt(self->ghoul2, 0, "mid_spine");
		ri->torsoBolt = g_trap->G2API_AddBolt(self->ghoul2, 0, "lower_spine");
		ri->crotchBolt = g_trap->G2API_AddBolt(self->ghoul2, 0, "rear_bone");
		//ri->elbowLBolt = g_trap->G2API_AddBolt(self->ghoul2, 0, "*l_arm_elbow");
		//ri->elbowRBolt = g_trap->G2API_AddBolt(self->ghoul2, 0, "*r_arm_elbow");
		ri->handLBolt = g_trap->G2API_AddBolt(self->ghoul2, 0, "*l_hand");
		ri->handRBolt = g_trap->G2API_AddBolt(self->ghoul2, 0, "*r_hand");
		//ri->kneeLBolt = g_trap->G2API_AddBolt(self->ghoul2, 0, "*hips_l_knee");
		//ri->kneeRBolt = g_trap->G2API_AddBolt(self->ghoul2, 0, "*hips_r_knee");
