...
void FX_RocketProjectileThink( centity_t *cent, const struct weaponInfo_s *weapon )
{
	...
	cg_trap->FX_PlayEffectID( cgs.effects.rocketShotEffect, cent->lerpOrigin, forward, -1, -1, qfalse );
}
...
{
	cg_trap->FX_PlayEffectID( cgs.effects.rocketExplosionEffect, origin, normal, -1, -1, qfalse );
}
