...
void BindSFMLGraphics(lua_State* L)
{
    ...
    [
        luabind::class_<sf::Vector2f>("Vector2f")
            ...
            .def(luabind::const_self + luabind::other<sf::Vector2f>())
            .def(luabind::const_self - luabind::other<sf::Vector2f>())
        ...
        luabind::class_<sf::Vector2i>("Vector2i")
            ...
            .def(luabind::const_self + luabind::other<sf::Vector2i>())
            .def(luabind::const_self - luabind::other<sf::Vector2i>())
        ...
        luabind::class_<sf::Vector2u>("Vector2u")
            ...
            .def(luabind::const_self + luabind::other<sf::Vector2u>())
            .def(luabind::const_self - luabind::other<sf::Vector2u>())
            .def(luabind::const_self * tempUnsignedInt())
            .def(luabind::const_self / tempUnsignedInt())
            .def(luabind::const_self == luabind::other<sf::Vector2u>())
