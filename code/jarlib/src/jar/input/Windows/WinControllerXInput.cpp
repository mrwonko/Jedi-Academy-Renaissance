...
WinControllerXInput::WinControllerXInput(unsigned int index) :
...
WinControllerXInput::~WinControllerXInput()
{
    //dtor
}

const bool WinControllerXInput::Init(unsigned int index)
{
    mXIndex = index;
...
const bool WinControllerXInput::Deinit()
{
    //not much to do here :-)
    return true;
}
...
void WinControllerXInput::CheckAxis(int oldValue, int newValue, int multiplicator, unsigned int axis)
{
...
std::string WinControllerXInput::GetUniqueID() const
{
