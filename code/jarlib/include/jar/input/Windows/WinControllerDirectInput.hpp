...
**/
class WinControllerDirectInput : public jar::InputDeviceController, public Updatable, public boost::noncopyable
{
    public:
        WinControllerDirectInput(unsigned int index);
        virtual ~WinControllerDirectInput();
